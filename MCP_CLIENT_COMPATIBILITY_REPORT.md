...
- **Source**: [code.visualstudio.com/docs/copilot/chat/mcp-servers](https://code.visualstudio.com/docs/copilot/chat/mcp-servers)
...
- **Source**: [docs.claude.com/en/docs/claude-code/sdk/sdk-mcp](https://docs.claude.com/en/docs/claude-code/sdk/sdk-mcp), [github.com/anthropics/claude-code](https://github.com/anthropics/claude-code)
...
- **Source**: [github.com/philschmid/gemini-samples](https://github.com/philschmid/gemini-samples)
...
- **Source**: [docs.augmentcode.com/setup-augment/mcp](https://docs.augmentcode.com/setup-augment/mcp)
